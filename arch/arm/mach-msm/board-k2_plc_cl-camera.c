...
static struct msm_camera_rawchip_info k2_plc_cl_msm_rawchip_board_info = {
...
struct platform_device k2_plc_cl_msm_rawchip_device = {
	.name	= "rawchip",
	.dev	= {
		.platform_data = &k2_plc_cl_msm_rawchip_board_info,
	},
};
#endif
...
#ifdef CONFIG_I2C
struct i2c_board_info k2_plc_cl_camera_i2c_boardinfo[] = {
...
struct i2c_board_info k2_plc_cl_camera_i2c_boardinfo_old[] = {
...
struct msm_camera_board_info k2_plc_cl_camera_board_info = {0};
#endif
...
void __init k2_plc_cl_init_cam(void)
{
	int rc = 0;
	int voltage = 0;
	...
	if (0) { /* Always probe ov5693 by default */
		...
		k2_plc_cl_camera_board_info.board_info = k2_plc_cl_camera_i2c_boardinfo_old;
		k2_plc_cl_camera_board_info.num_i2c_board_info = ARRAY_SIZE(k2_plc_cl_camera_i2c_boardinfo_old);
	} else {
		k2_plc_cl_camera_board_info.board_info = k2_plc_cl_camera_i2c_boardinfo;
		k2_plc_cl_camera_board_info.num_i2c_board_info = ARRAY_SIZE(k2_plc_cl_camera_i2c_boardinfo);
	}
#endif
