...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 0, {  1620000, HFPLL, 1, 0, 0x3A }, L2(18), 1250000 },
	{ 0, {  1728000, HFPLL, 1, 0, 0x3C }, L2(19), 1262500 },
	{ 0, {  1809000, HFPLL, 1, 0, 0x3E }, L2(19), 1262500 },
        { 0, {  1890000, HFPLL, 1, 0, 0x40 }, L2(19), 1300000 },
	{ 0, {  1971000, HFPLL, 1, 0, 0x42 }, L2(19), 1300000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	...
	{ 0, {  1620000, HFPLL, 1, 0, 0x3A }, L2(19), 1200000 },
	{ 0, {  1728000, HFPLL, 1, 0, 0x3C }, L2(19), 1250000 },
	{ 0, {  1836000, HFPLL, 1, 0, 0x3E }, L2(19), 1275000 },
	{ 0, {  1890000, HFPLL, 1, 0, 0x40 }, L2(19), 1300000 },
	{ 0, {  1971000, HFPLL, 1, 0, 0x42 }, L2(19), 1300000 },
	{ 0, { 0 } }
};
...
static struct l2_level l2_freq_tbl_8930[] = {
	...
	[18] = { { 1350000, HFPLL, 1, 0, 0x30 }, LVL_HIGH, 1150000, 7 },
	[19] = { { 1458000, HFPLL, 1, 0, 0x32 }, LVL_HIGH, 1150000, 7 },
};
...
static struct acpu_level acpu_freq_tbl_8930_nom[] = {
	...
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(6),   950000 },
	...
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(16), 1150000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(16), 1150000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(16), 1175000 },
...
static struct acpu_level acpu_freq_tbl_8930_fast[] = {
	...
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(6),   925000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(6),   925000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(6),   950000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(6),   950000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(11), 1000000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(11), 1000000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(11), 1025000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(11), 1025000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(11), 1050000 },
